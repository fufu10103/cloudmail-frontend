    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-100 px-6 py-3.5 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-4">
          <Link href="/mailbox" className="p-2 hover:bg-gray-100 rounded-xl transition">
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          {error && (
            <div className="mx-6 mt-5 p-3.5 bg-red-50 border border-red-200 text-red-600 rounded-xl text-sm flex items-center gap-2 animate-fade-in">
          ...
          <form onSubmit={handleSend} className="p-6">
            ...
            <div className="flex items-center border-b border-gray-100 py-3">
              <label className="w-20 text-sm font-medium text-gray-500 flex-shrink-0">收件人</label>
              <input
                type="text"
                value={to}
            ...
            {/* 抄送 */}
            {showCc && (
              <div className="flex items-center border-b border-gray-100 py-3 animate-fade-in">
                <label className="w-20 text-sm font-medium text-gray-500 flex-shrink-0">抄送</label>
                <input
                  type="text"
                  value={cc}
            ...
            {/* 主题 */}
            <div className="flex items-center border-b border-gray-100 py-3">
              <label className="w-20 text-sm font-medium text-gray-500 flex-shrink-0">主题</label>
              <input
                type="text"
                value={subject}
            ...
            <div className="py-4">
              <textarea
                ...
                className="w-full h-96 outline-none text-gray-800 placeholder-gray-400 resize-none bg-transparent leading-relaxed"
            ...
            <div className="flex items-center justify-between pt-5 border-t border-gray-100">
              <div className="flex items-center gap-1">
                <button type="button" className="p-2.5 hover:bg-gray-100 rounded-xl text-gray-500 transition" title="添加附件">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" />
                  </svg>
                </button>
                <button type="button" className="p-2.5 hover:bg-gray-100 rounded-xl text-gray-500 transition" title="插入表情">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </button>
                <button type="button" className="p-2.5 hover:bg-gray-100 rounded-xl text-gray-500 transition" title="保存草稿">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-3">
                <Link href="/mailbox" className="px-5 py-2.5 text-sm text-gray-600 hover:bg-gray-100 rounded-xl transition font-medium">
                  取消
                </Link>
                <button
                  type="submit"
                  disabled={sending}
                  className="px-7 py-2.5 btn-gradient text-white text-sm font-semibold rounded-xl disabled:opacity-50 disabled:cursor-not-allowed shadow-lg flex items-center gap-2"
                >
                  {sending ? (
                    <>
